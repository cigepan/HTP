...
pushd D:\mongodb\mongo-cxx-driver-master\build\install\
...
echo Removing file lib\cmake\libbsoncxx-3.6.4\libbsoncxx-config.cmake
del lib\cmake\libbsoncxx-3.6.4\libbsoncxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libbsoncxx-3.6.4\libbsoncxx-config-version.cmake
del lib\cmake\libbsoncxx-3.6.4\libbsoncxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\bsoncxx-3.6.4\bsoncxx_targets.cmake
del lib\cmake\bsoncxx-3.6.4\bsoncxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.6.4\bsoncxx_targets-release.cmake
del lib\cmake\bsoncxx-3.6.4\bsoncxx_targets-release.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.6.4\bsoncxx-config-version.cmake
del lib\cmake\bsoncxx-3.6.4\bsoncxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.6.4\bsoncxx-config.cmake
del lib\cmake\bsoncxx-3.6.4\bsoncxx-config.cmake || echo ... not removed
...
echo Removing file lib\cmake\libmongocxx-3.6.4\libmongocxx-config.cmake
del lib\cmake\libmongocxx-3.6.4\libmongocxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libmongocxx-3.6.4\libmongocxx-config-version.cmake
del lib\cmake\libmongocxx-3.6.4\libmongocxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\mongocxx-3.6.4\mongocxx_targets.cmake
del lib\cmake\mongocxx-3.6.4\mongocxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.6.4\mongocxx_targets-release.cmake
del lib\cmake\mongocxx-3.6.4\mongocxx_targets-release.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.6.4\mongocxx-config-version.cmake
del lib\cmake\mongocxx-3.6.4\mongocxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.6.4\mongocxx-config.cmake
del lib\cmake\mongocxx-3.6.4\mongocxx-config.cmake || echo ... not removed
...
echo Removing directory lib\cmake\bsoncxx-3.6.4
(rmdir lib\cmake\bsoncxx-3.6.4 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libbsoncxx-3.6.4
(rmdir lib\cmake\libbsoncxx-3.6.4 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libmongocxx-3.6.4
(rmdir lib\cmake\libmongocxx-3.6.4 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\mongocxx-3.6.4
(rmdir lib\cmake\mongocxx-3.6.4 2>NUL) || echo ... not removed (probably not empty)
...
cd ..
echo Removing top-level installation directory: D:\mongodb\mongo-cxx-driver-master\build\install\
(rmdir D:\mongodb\mongo-cxx-driver-master\build\install\ 2>NUL) || echo ... not removed (probably not empty)
